...
if (strlen($_SESSION['login']) == 0) {
    ...
    if (isset($_POST['submit'])) {
        ...
        $sql = mysqli_query($con, "SELECT password FROM  tblusers where username='$userid'");
        ...
        if ($num > 0) {
            ...
            if (password_verify($password, $dbpassword)) {
                ...
                $con = mysqli_query($con, "update tblusers set password='$newhashedpass' where username='$userid'");
